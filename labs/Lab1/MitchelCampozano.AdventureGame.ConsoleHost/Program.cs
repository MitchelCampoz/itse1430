...
namespace MitchelCampozano.AdventureGame.ConsoleHost
{
    class Program
    {
        static void Main ( string[] args )
        {
            ...
            do
            {
                string action = GameAction("What would you like to do, Adventurer?");
        ...
        static string GameAction ( string message )
        {
            while (true)
            {
                ...
                string holder = action.ToUpper();

                if (holder.Contains("MOVE"))
                    CheckMove(holder);
                else if (holder.Contains("LOOK"))
                    CheckLook(placeX, placeY);
                else if (holder.Contains("QUIT"))
                    return "QUIT";
                else if (holder.Contains("HELP"))
                    ControlHelp();
                else
        ...
        static void Hallway ()
        {
            ...
            Console.WriteLine("It seems the main defenders of the temple crowded specifically here to defend the room ahead.");
